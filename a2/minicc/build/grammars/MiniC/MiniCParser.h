...
public:
  enum {
    ...
    T__32 = 33, ID = 34, INT = 35, WS = 36, COMMENT = 37
  };

  enum {
    RuleProg = 0, RulePreamble = 1, RuleDecl = 2, RuleVardecl = 3, RuleScope = 4, 
    RuleStmt = 5, RuleStmt_list = 6, RuleVarlist = 7, RuleVarlistentry = 8, 
    ...
    RuleArguments = 17, RuleArgumentlist = 18, RuleVarname = 19, RuleFuncname = 20, 
    RuleParametername = 21
  };
