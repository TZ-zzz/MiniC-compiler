...
namespace minicc {
    ...
    class IRGenerator : public ASTVisitor {
        ...
        std::map<Expr *, llvm::Value *> expr_map;
        std::vector<llvm::BasicBlock*> break_stmts;
    public:
        //modify if needed
        ...
        llvm::Type *getLLVMType(Type::PrimitiveTypeEnum type);

        llvm::Value *getLLVMValue(Expr* expr);
